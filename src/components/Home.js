      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <p>
            ...
            repudiandae, illum amet veniam tempora fugit, laudantium ad nam unde
            vitae eum doloribus incidunt quidem quia velit nostrum doloremque
            nihil.
          </p>
          <button onClick={handleNotLogin} className="btn btn-success mr-3">
            Create Campaign
          </button>
          <button
            onClick={exploreCampaignClickHandler}
        ...
        <div className="col-md-3">
          <div className="card">
            <div className="card-body">
              ...
              <p>
                <strong>Target:</strong> 4ETH
              </p>
              <p>
                <strong>Received:</strong> 2ETH
              </p>
